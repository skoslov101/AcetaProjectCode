...
instructions = {'During practice we will show you the correct response buttons.',...
    ...
    '',...
    'So please try your best to remember: ' instrInst1 instrInst2 instrInst3,...
    '',...
...
for pracI=1:18
    ...
    if resp==CR
        acc=1;
        cenTex_stroop({'CORRECT!'},window,screenRect,greenFeed,white,100,respBut)
    else
        acc=0;
        cenTex_stroop({'INCORRECT.'},window,screenRect,redFeed,white,100,respBut)
    end
    pause(1*speedup)
...
instructions = {'Great job!',...
    ...
    '',...
    'Please try your best to remember: ' instrInst1 instrInst2 instrInst3,...
    '',...
...
% for blockI=1:1
    ...
    if blockI>1
        betBlock_instructions = {'You are done with that block of the task.',...
            ...
            '',...
            'In case you forgot: ' instrInst1 instrInst2 instrInst3,...
            '',...
            'Press the SPACEBAR to begin the task.'};
